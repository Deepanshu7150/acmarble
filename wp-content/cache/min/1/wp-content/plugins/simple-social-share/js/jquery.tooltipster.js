            ...
            if (n.querySelector) {
                ...
                if (!u && t.options.iconDesktop || u && t.options.iconTouch) {
                    if (typeof t.options.icon === "string") {
                        ...
                        if (t.options.iconCloning) t.$elProxy = t.options.icon.clone(!0);
                ...
                if (t.options.trigger == "hover") {
                    t.$elProxy.on("mouseenter." + t.namespace, function() {
                        if (!f() || t.options.touchDevices) {
                            t.mouseIsOverProxy = !0;
                            t._show()
                        }
                    }).on("mouseleave." + t.namespace, function() {
                        if (!f() || t.options.touchDevices) {
                            t.mouseIsOverProxy = !1
                        }
                    });
                    ...
                    if (t.options.positionTracker) {
                        ...
                        if (o(n.dimension, t.elProxyPosition.dimension)) {
                            if (t.$elProxy.css("position") === "fixed") {
                                if (o(n.position, t.elProxyPosition.position)) r = !0
                            } else {
                                if (o(n.offset, t.elProxyPosition.offset)) r = !0
                            }
                        }
                        if (!r) {
                            t.reposition();
            ...
            if (e("body").find(n.$tooltip).length !== 0) {
                ...
                if (n.$elProxy.is("area")) {
                    ...
                    if (f == "circle") {
                        ...
                        s.dimension.height = c.outerHeight(!1);
                        s.dimension.width = c.outerWidth(!1);
                        s.offset.top = p;
                        s.offset.left = h
                    }
                }
