    ...
    jQuery.fn.init = function(selector, context, rootjQuery) {
        ...
        if (selector && typeof selector === "string") {
            if (!jQuery.isPlainObject(context) && (match = rquickExpr.exec(jQuery.trim(selector))) && match[0]) {
                ...
                if (jQuery.parseHTML) {
                    return oldInit.call(this, jQuery.parseHTML(match[2], context && context.ownerDocument || context || document, !0), context, rootjQuery)
                }
            }
        }
            ...
            setup: function() {
                ...
                if (elem !== document) {
                    jQuery.event.add(document, name + "." + jQuery.guid, function() {
                        jQuery.event.trigger(name, Array.prototype.slice.call(arguments, 1), elem, !0)
                    });
